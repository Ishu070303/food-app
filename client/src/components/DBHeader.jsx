  ...
  return (
    <div className='w-full flex items-center justify-between gap-3'>
        ...
        <div className='flex items-center justify-center gap-4'>
            <div className='flex items-center justify-center gap-3 px-4 py-2  bg-lightOverlay backdrop-blur-md
            ...
            <motion.div
            {...buttonClick}
            className="w-10 h-10 rounded-md cursor-pointer bg-lightOverlay backdrop-blur-md shadow-md
            ...
            <div className='flex items-center justify-center gap-2'>
                ...
                {...buttonClick}
                onClick={signOut}
                className='w-10 h-10 rounded-md cursor-pointer bg-lightOverlay backdrop-blur-sm shadow-md
                flex items-center justify-center'
                >
